...
#define FLAG_P_EGG_MOVES                                            (SYS_FLAGS + 0xE6)
#define FLAG_P_TUTOR_MOVES                                          (SYS_FLAGS + 0xE7)
#define FLAG_OW_PAUSE_TIME                                          (SYS_FLAGS + 0xE8)
#define FLAG_OW_NO_ENCOUNTER                                        (SYS_FLAGS + 0xE9)
#define FLAG_OW_NO_TRAINER_SEE                                      (SYS_FLAGS + 0xEA)
#define FLAG_OW_NO_COLLISION                                        (SYS_FLAGS + 0xEB)
#define FLAG_OW_POKE_RIDER                                          (SYS_FLAGS + 0xEC)
#define FLAG_I_VS_SEEKER_CHARGING                                   (SYS_FLAGS + 0xED)
#define FLAG_I_EXP_SHARE_FLAG                                       (SYS_FLAGS + 0xEE)
#define FLAG_FNPC_HEAL_AFTER_FOLLOWER_BATTLE                        (SYS_FLAGS + 0xEF)
#define FLAG_FNPC_PARTNER_WILD_BATTLES                              (SYS_FLAGS + 0xF0)
#define FLAG_DN_SEARCHING                                           (SYS_FLAGS + 0xF1)
#define FLAG_DN_DEXNAV_GET                                          (SYS_FLAGS + 0xF2)
#define FLAG_DN_DETECTOR_MODE                                       (SYS_FLAGS + 0xF3)
#define FLAG_B_INVERSE_BATTLE                                       (SYS_FLAGS + 0xF4)
#define FLAG_B_FORCE_DOUBLE_WILD                                    (SYS_FLAGS + 0xF5)
#define FLAG_B_SMART_WILD_AI                                        (SYS_FLAGS + 0xF6)
#define FLAG_B_NO_CATCHING                                          (SYS_FLAGS + 0xF7)
#define FLAG_B_NO_RUNNING                                           (SYS_FLAGS + 0xF8)
#define FLAG_B_AI_VS_AI_BATTLE                                      (SYS_FLAGS + 0xF9)
#define FLAG_B_DYNAMAX_BATTLE                                       (SYS_FLAGS + 0xFA)
#define FLAG_B_TERA_ORB_CHARGED                                     (SYS_FLAGS + 0xFB)
#define FLAG_B_TERA_ORB_NO_COST                                     (SYS_FLAGS + 0xFC)
#define FLAG_B_SLEEP_CLAUSE                                         (SYS_FLAGS + 0xFD)
#define FLAG_B_NO_WHITEOUT                                          (SYS_FLAGS + 0xFE)
#define FLAG_B_SKY_BATTLE                                           (SYS_FLAGS + 0xFF)

#define FLAGS_COUNT (FLAG_B_SKY_BATTLE + 1)

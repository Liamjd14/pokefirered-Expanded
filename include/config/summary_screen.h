...
#define P_FLAG_EGG_MOVES                 FLAG_P_EGG_MOVES       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               FLAG_P_TUTOR_MOVES       // If this flag is set, enables tutor move relearner.
